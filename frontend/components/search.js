            ...
            <section className={styles.searchHeader}>
                <section className={styles.searchSection}>
                    ...
                    <section className={styles.input_section}>
                        <input className={styles.inputField} type="text" id="inputField" name="inputField" maxLength="120" placeholder="Search by Address / Txn Hash / Block / Token / Domain Name" required onChange={changeHandler} />
              ...
              >
                ...
                <section className={styles.adSection}>
                    <p className={styles.adText} >
                        maheshmannava.eth <br />
                    </p>
                    <section>
                        <Illustration logo="ethereum" className={styles.ethereum} />
                    </section>
                </section>
            </section>
